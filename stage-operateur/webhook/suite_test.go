...
var _ = BeforeSuite(func(done Done) {
	...
	Expect(err).NotTo(HaveOccurred(), "failed to setup Project controller")
	...
	Expect(err).NotTo(HaveOccurred(), "failed to setup Namespace controller")
